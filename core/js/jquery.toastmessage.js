...
(function($) {
	...
	var methods = {
		...
		showToast: function(options) {
			...
			toastItemOuter = $('<div></div>').addClass('alert alert-' + localSettings.type);
			toastItemInner = $('<div></div>').hide().appendTo(toastWrapAll).html($('<span>').append(localSettings.text)).animate(localSettings.inEffect, localSettings.inEffectDuration).wrap(toastItemOuter);
			toastItemClose = $('<button type="button" aria-hidden="true">&times;</button>').addClass('close').prependTo(toastItemInner).click(function() {
